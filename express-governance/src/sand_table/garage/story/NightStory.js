...
class NightStory {
    ...
    init() {
        this.regularStory = new RegularStory(this.sandTable)
        this.sandTable.changeLifterStatus(2, -1)
        this.sandTable.lifterList.forEach((lifter) => this.sandTable.downLifter(lifter.id))
    }
