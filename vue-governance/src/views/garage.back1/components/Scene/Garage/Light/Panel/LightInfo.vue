<template>
  <div class="light_info_outer_panel" :style="position">
    <div class="content_panel">
      <div class="light_info_panel">
        <div class="light_icon_panel">
          <i
            class="iconfont icon-light light_icon"
            :style="{ color: lightOpen ? 'white' : 'gray' }"
          ></i>
        </div>
        <span
          class="content_span"
...
export default {
  ...
  methods: {
    ...
    closeLight() {
      this.$axios.get(`/garage/light/close/${this.id}`);
    },

    openLight() {
      this.$axios.get(`/garage/light/open/${this.id}`);
    },
  },
  mounted() {},
};
