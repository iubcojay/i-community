<template>
  <div class="outer_panel">
    <div class="wrap_panel">
      <arch-panel-component position="right" height="290px" title="充电进度提示" class="arch-panel">
    ...
    <div class="wrap_panel">
      <arch-panel-component position="right" height="290px" title="人员轮班表" class="arch-panel">
        <template slot="content">
    ...
    <div class="wrap_panel">
      <arch-panel-component position="right" height="290px" title="道闸监控" class="arch-panel">
        <template slot="content">
          <div class="monitor_panel">
            <div class="monitor_title_panel">
              <div class="monitor_position_panel">
                <i class="iconfont icon-monitor"></i>
                <div class="monitor_position_text_panel">南门-出入口</div>
              </div>
