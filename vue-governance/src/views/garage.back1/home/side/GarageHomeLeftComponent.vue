<template>
  <div class="outer_panel">
    <div class="wrap_panel">
      <arch-panel-component position="left" height="290px" title="停车情况" class="arch-panel">
    ...
    <div class="wrap_panel">
      <arch-panel-component position="left" height="290px" title="能源消耗分析" class="arch-panel">
        <template slot="content">
    ...
    <div class="wrap_panel">
      <arch-panel-component position="left" height="290px" title="消防设备检修" class="arch-panel">
        <template slot="content">
              ...
              <div class="arrow_panel">
                <div class="item_panel">
                  ...
                  <div class="number_panel">
                    <countTo :startVal='facilityData.fireProtectionNumber - 5'
                             :endVal='facilityData.fireProtectionNumber'
                             :duration='1000' :decimals="0"></countTo>
                  </div>
                </div>
                <div class="item_panel">
...
export default {
  ...
  methods: {
    ...
    handleHeightCollapse() {
      this.$nextTick(() => {
        document.querySelectorAll('.wrap_panel').forEach(element => element.style.height = element.childNodes[0].offsetHeight + 'px')
      })
    },
