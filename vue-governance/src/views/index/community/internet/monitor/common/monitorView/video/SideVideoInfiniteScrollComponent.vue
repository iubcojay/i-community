        ...
        initStyle() {
            this.$nextTick(() => {
                ...
                document.styleSheets[0].insertRule(
                    `   
                         @keyframes fire_side_bar_scroll_up {
                            0% {
                                top: 0
                            }
                ...
                document.styleSheets[0].insertRule(
                    `   
                        @keyframes fire_side_bar_scroll_down {
                            0% {
                                bottom: 0
                            }
                ...
                this.$refs['contentListPanel'].style.animation = `fire_side_bar_scroll_${this.direction} infinite ${this.videoList.length * this.speed}s linear `
            })
        },
