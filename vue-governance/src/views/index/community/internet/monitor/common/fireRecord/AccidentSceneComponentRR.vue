...
<script>
import TransportComponent from "@/views/index/community/internet/monitor/common/fireRecord/TransportComponentRR.vue";
import FireTruckComponent from "@/views/index/community/internet/monitor/common/fireRecord/FireTruckComponentRR.vue";
import TimeLineComponent from "@/views/index/community/internet/monitor/common/fireRecord/TimeLineComponentRR.vue";
export default {
  name: "AccidentSceneComponentRR",
  components: {
    TransportComponent,
    FireTruckComponent,
    TimeLineComponent,
