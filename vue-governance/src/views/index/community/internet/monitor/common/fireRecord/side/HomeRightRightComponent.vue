<template>
  <div class="home_right_panel">
    <div class="home_right_content_panel">
      <ArchPanelComponent  style="flex:1;margin-bottom: 10px;width: 80%;position: static" title="社区规模" position="right">
            ...
            <div class="statistics_data_panel">
              <div class=" statistics_data_sub_panel">
                <div class="statistics_img_panel">
                  <el-image :src="$StaticResourceAddress+'/img/home/ground.png'" style="height: 100%;width: 100%"></el-image>
                </div>
                <div class="statistics_text_panel">
                  <div class="statistics_text_title">总面积</div>
                  <div class="statistics_text_content">
                    <countTo :startVal='communityScaleData.totalArea-500' :endVal='communityScaleData.totalArea' :duration='1000' suffix='㎡' :decimals="0"></countTo>
                  </div>
                </div>
              ...
              <div class=" statistics_data_sub_panel">
                <div class="statistics_img_panel">
                  <el-image :src="$StaticResourceAddress+'/img/home/building.png'" style="height: 100%;width: 100%"></el-image>
                </div>
                <div class="statistics_text_panel">
                  <div class="statistics_text_title">建筑面积</div>
                  <div class="statistics_text_content">
                    <countTo :startVal='communityScaleData.buildingArea-500' :endVal='communityScaleData.buildingArea' :duration='1000' suffix='㎡' :decimals="0"></countTo>
                  </div>
                </div>
              ...
              <div class=" statistics_data_sub_panel">
                <div class="statistics_img_panel">
                  <el-image :src="$StaticResourceAddress+'/img/home/population.png'" style="height: 100%;width: 100%"></el-image>
                </div>
                <div class="statistics_text_panel">
                  <div class="statistics_text_title">社区人口</div>
                  <div class="statistics_text_content">
                    <countTo :startVal='communityScaleData.peopleNum-5000' :endVal='communityScaleData.peopleNum' :duration='1000' suffix='人' :decimals="0"></countTo>
                  </div>
                </div>
              ...
              <div class=" statistics_data_sub_panel">
                <div class="statistics_img_panel">
                  <el-image :src="$StaticResourceAddress+'/img/home/car.png'" style="height: 100%;width: 100%"></el-image>
                </div>
                <div class="statistics_text_panel">
                  <div class="statistics_text_title">社区车辆</div>
                  <div class="statistics_text_content">
                    <countTo :startVal='communityScaleData.carNum-20' :endVal='communityScaleData.carNum' :duration='1000' suffix='辆' :decimals="0"></countTo>
                  </div>
                </div>
      ...
      <ArchPanelComponent style="height: 380px;margin-bottom: 10px;width: 80%;position: static" title="告警提示" position="right">
        <template slot="content">
          <VueSeamlessScroll v-if="nextTickFlag" :data="warningTableData" class="warning_panel_warp" :class-option="situationOption">
            <el-table
                ref="taskTable"
          ...
          series: [
            {
              ...
              data: [112364,122364,133364, 143364, 143364, 143364, 152364, 150400, 152364]
            },
          ]
        };
        // 使用刚指定的配置项和数据显示图表。
