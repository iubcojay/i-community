    ...
    <div class="center_panel">
      ...
      >
        ...
        >
          ...
          ></video>
          <div class="position_text_panel">
            {{ displayVideoList[index].position }}
          </div>
          <div
...
import FireEffect from "@/assets/js/cesium/FireEffect.js";
export default {
  ...
  methods: {
    handleAddressClick(videoInfo) {
      ...
      this.fire = new FireEffect(
        ...
        Cesium.Cartesian3.fromRadians(...videoInfo.address)
      );
    },
  },
