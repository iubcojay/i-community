<template>
    <div class="controller_panel">
      <SideBarComponent class="side_bar_panel" v-if="ifDataInit">
        <ProcessCellDistributionLeftComponent
          ...
          ref="leftPanel"
        ></ProcessCellDistributionLeftComponent>
        <ProcessCellDistributionRightComponent
  ...
  import ProcessCellDistributionLeftComponent from '@/views/index/community/governance/process/cell/taskdis/side/ProcessCellDistributionLeftComponent'
  import ProcessCellDistributionRightComponent from '@/views/index/community/governance/process/cell/taskdis/side/ProcessCellDistributionRightComponent'
  ...
  ``
  export default {
    name: "ProcessCellDistributionControllerComponent",
    components: {
      SideBarComponent,
      ProcessCellDistributionLeftComponent,
      ProcessCellDistributionRightComponent,
    ...
    methods: {
      ...
      async submitTask(task, selectedParticipantList) {
        await this.$axios.post('/task/cell/appoint',this.$common.packagingAxiosParam({
          taskId: task.id,
          userId: this.userInfo.id,
