      ...
      >
        <div class="user_panel">
          <div class="profile_panel">
            <img
              class="profile_img"
              :src="$StaticResourceAddress + user.profile"
            />
          </div>
        ...
        <div class="detail_button_panel">
          <i class="iconfont icon-city icon_city" @click="handleIconBuildingClick"></i>
          <i class="iconfont icon-path icon_path" @click="handleIconPathClick"></i>
        </div>
      </div>
    </div>
  </div>
...
<script>
export default {
  name: "ProgressGridNodeComponent",
  ...
  computed: {
    ...
    progressPathCallback(){
      return  this.nodeData.progressPathCallback
    },

    progressPathBuildingCallback(){
      return this.nodeData.progressPathBuildingCallback
    }
  },
  methods: {
    ...
    handleIconPathClick(){
      this.progressPathCallback(this.participant)
    },

    handleIconBuildingClick(){
      this.progressPathBuildingCallback(this.participant)
    }
