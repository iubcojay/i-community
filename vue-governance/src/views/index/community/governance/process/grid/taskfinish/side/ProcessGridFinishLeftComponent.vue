<template>
    <div class="outer_panel">
      <FolderPanelComponent title="待提交任务" position="left">
            ...
            <div class="task_list_panel" ref="taskListPanel">
              ...
              >
                <div
                  ...
                  :class="{
                    task_item_selected_panel: selectedTask.id === task.id,
                  }"
  ...
  export default {
    name: "ProcessGridFinishLeftComponent",
    ...
    methods: {
      ...
      deleteShowItem(taskId) {
        // 开启动画
        this.ifTransitionAnimationPlay = true;
        this.showTaskList.splice(
          this.showTaskList.findIndex((item) => item.id == taskId),
          1
        );
        // 延迟更新数据
        setTimeout(() => {
