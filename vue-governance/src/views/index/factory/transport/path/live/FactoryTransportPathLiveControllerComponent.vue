<template>
  <div class="factory_truck_container">
    <side-bar-component>
      <factory-transport-path-live-left-component
    ...
    <div class="truck_live_path_container">
...
import FactoryTransportPathLiveLeftComponent from "@/views/index/factory/transport/path/live/side/left/FactoryTransportPathLiveLeftComponent";
import LiveTruckPathComponent from "@/views/index/factory/transport/path/live/components/LiveTruckPathComponent";

import { mapMutations } from "vuex";

export default {
  name: "FactoryTransportPathLiveControllerComponent",
  components: {
    SideBarComponent,
    FactoryTransportPathLiveLeftComponent,
