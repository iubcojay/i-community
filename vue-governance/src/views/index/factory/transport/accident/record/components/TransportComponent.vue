...
import AccidentPoiComponent from "./AccidentPoiComponent";
import PublicSentimentPoiComponent from "./PublicSentimentPoiComponent";
    ...
    changeToAccidentStatus() {
      this.$nextTick(() => {
        ...
        tl.fromTo(
          accidentEntity,
          { warningRadius: 0 },
          { warningRadius: 100, duration: 4, repeat: -1 }
        );
